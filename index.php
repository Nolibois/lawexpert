            ...
            <div class="rd-navbar-inner">
              ...
              <div class="rd-navbar-group">
                <div class="rd-navbar-panel">
                  <button class="rd-navbar-toggle" data-rd-navbar-toggle=".rd-navbar-nav-wrap"><span></span></button><a class="rd-navbar-brand brand" href="index.php"><img class="lazy-img" src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs%3D" data-src="images/logo-default-143x27.png" alt="" width="143" height="27"/></a>
                </div>
          ...
          <div class="row">
            <div class="col-md-10 col-lg-9 col-xl-7">
              <div class="section-50 section-md-75 section-xl-100">
                ...
                <div class="box-cart-body">
                  <?php $form->displayInfosContact($_POST); ?>
                </div>
                  ...
                  <div class="row row-30">
                    ...
                    <div class="col-md-6">
                      <div class="form-wrap form-wrap-outside">
                        <?php $form->createSelect('Family Law', 'Business Law', 'Civil Litigation'); ?>
                      </div>
                    </div>
                    <div class="col-12">
                      <div class="form-wrap">
                    ...
                    <div class="col-12">
                      <div class="row">
                        <div class="col-md-6">
                          <?php $form->createSubmit("Request A Free Cconsultation"); ?>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="col-sm-9 col-md-11 col-xl-12">
                <div class="row row-50">
                  <div class="col-md-6 col-lg-10 col-xl-3">
                    <div class="inset-xl-right-20" style="max-width: 510px;"><a class="brand" href="index.php"><img class="lazy-img" src="data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs%3D" data-src="images/logo-inverse-143x28.png" alt="" width="143" height="28"/></a>
                      <p>
